...
export default function ItineraryItem({ id, index, wishlistItem, destName, destDesc, destImg, itemNote }: ItineraryItemProps) {
  ...
  return (
    <Draggable draggableId={id.toString()} index={index}>
      {(provided) => (
        <div ref={provided.innerRef} {...provided.draggableProps} {...provided.dragHandleProps} className="itinerary-item flex flex-row items-center">
          <div className={`shrink bg-gray-50 rounded-lg border-1 border-dashed overflow-hidden ${wishlistItem ? "w-55 h-18 flex-none" : "w-full min-h-20"}`}>
            ...
            <div className="flex flex-nowrap justify-between items-center h-full">
              ...
              <svg className="move-icon w-10 grow-0 shrink-0" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M5.14285 8.57144H18.8571M5.14056 12H18.8514M5.14285 15.4286H18.8514" stroke="black"/>
              </svg>
            </div>
